...
declare global {
  interface Window {
    material: {
      ...
      /** Determines whether to set the 'checked' value of m-radio element to false if another m-radio element with the same name of the same form element is selected. */
